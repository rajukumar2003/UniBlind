    ...
    <section>
      <div className="absolute inset-0 flex flex-col justify-center items-start text-left text-white font-worksans leading-none m-10">
        ...
        <div className="flex justify-center">
          <button className="m-2 py-2 px-4 rounded-lg bg-[#86B6F6] text-white drop-shadow-lg w-28 h-10">
            Log in
          </button>
          <button className="m-2 py-2 px-4 rounded-lg bg-white text-[#86B6F6] drop-shadow-lg w-28 h-10">
            Sign In
          </button>
        </div>
      </div>
