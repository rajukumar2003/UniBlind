  ...
  return (
    <div className=" p-4 pb-2 mb-3 w-full h-full">
      <div className="flex justify-between">
        <h1 className="text-md text-slate-gray font-semibold mb-3">
          {username}
        </h1>
        {/* Delete Menu */}
      ...
      <div className="flex flex-row max-sm:flex-col">
        <div className="">
          ...
          <img
            src={imgURL}
            alt="post image"
            className={` rounded-md object-contain w-[300px] h-[200px] black-shad mr-10 cursor-pointer max-sm:mx-auto ${isImageClicked ? "w-full h-full" : ""}`}
            onClick={toggleImgeClick}
          />
          {/* )} */}
        </div>

        <div className="flex flex-col ml-5 max-sm:ml-0">
          <h3 className="mt-1 max-sm:mt-3 font-montserrat text-lg font-semibold">
            {title}
          </h3>
          <p className="mt-6 max-sm:mt-2 max-w-md text-sm font-montserrat">
            {message}
          </p>
        </div>
      </div>
